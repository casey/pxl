...
impl ShaderCache {
  ...
  pub fn compile_program(
    ...
    unsafe {
      ...
      let zsource = CString::new("source").unwrap();
      let source_uniform = gl::GetUniformLocation(program, zsource.as_ptr());
      gl::Uniform1i(source_uniform, 0);

      let zsamples = CString::new("samples").unwrap();
